...
TileSystem* TileSystem::TileSystemInstance = nullptr;
//---------------------------------------------------------------------------------
void StartCounter()
{
	LARGE_INTEGER li;
...
void Display()
{
	...
	GameManager::getInstance()->Render();			// Call user defined render.
...
{	
	...
	{	
		...
		GameManager::getInstance()->Update((float)deltaTime);				// Call user defined update.
